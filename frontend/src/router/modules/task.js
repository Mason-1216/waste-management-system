export const taskRoutes = [
  ...
  },
  {
    ...
    name: 'PositionWork',
    component: () => import('@/modules/task/pages/PositionWork.vue'),
    meta: { title: '\u56fa\u5b9a\u4efb\u52a1' },
  ...
  },
  {
    ...
    component: () => import('@/modules/task/pages/PositionWorkRecords.vue'),
  ...
  },
  {
    ...
    component: () => import('@/modules/task/pages/TemporaryTasks.vue'),
    meta: { title: '\u4e34\u65f6\u4efb\u52a1\u586b\u62a5' },
    props: { mode: 'fill' }
  },
  {
  ...
  },
  {
    ...
    component: () => import('@/modules/task/pages/TempTaskLibrary.vue'),
