...
- 后端(Validation): 新增 modules/core/validators/validate.js，并在 system_config、notification、support(feedback)、approval、equipment、report、schedule 模块接入 Joi 校验（不改接口返回结构）。
